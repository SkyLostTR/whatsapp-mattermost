...
class WhatsAppEmojiMap {
    ...
    public function __construct() {
        ...
        $this->add('f09f998f', ':pray:');
        $this->add('f09f988d', ':heart_eyes:');
        $this->add('f09f9894', ':pensive:');
        $this->add('f09f9895', ':confused:');
    }
    ...
    public function get(string $waEmoji): ?string {
        ...
        // Return a default emoji placeholder instead of throwing an exception
        error_log("Warning: Unknown emoji " . $waEmoji . " - using default placeholder");
        return ':question:';
    }
